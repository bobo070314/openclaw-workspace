...
TOKEN_MAP = {
    ...
    "linear_token": {"env": "LINEAR_API_KEY", "label": "Linear Token (lin_api_xxx)", "skills": ["linear"]},
    "tencent_docs_token": {"env": "TENCENT_DOCS_API_KEY", "label": "腾讯文档 Token", "skills": ["tencent-docs"]},
